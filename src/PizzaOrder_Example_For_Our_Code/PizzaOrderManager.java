package PizzaOrder_Example_For_Our_Code;

import java.util.Scanner;

//    This code from github (I added it just for example) .
//    Here we can see good examples for our code.
//    Ex: ==> How to  comment our code and etc.
